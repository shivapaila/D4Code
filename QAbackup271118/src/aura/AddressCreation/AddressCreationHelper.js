...
// EDQ added Validation logic
    ...
    getSuggestions: function (component, settings) {
        ...
        if ("undefined" === typeof searchTermValue || searchTermValue.length < 2) {
            return;
        }
    ...
    getCountry: function (component, settings) {
        if (this.isNullOrEmpty(this.getElementValue(component, settings.country.auraId))) {
